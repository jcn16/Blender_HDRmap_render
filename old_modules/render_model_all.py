...
root='/media/jcn/新加卷/JCN/CLOTHES/test_model'
...
for model in model_path_1:
	...
	render_path ='/media/jcn/新加卷/JCN/CLOTHES/test_model'
	...
	context=bpy.context
	# create a camera
	with open('/media/jcn/新加卷/Nerf/Nerf/NLT/metadata/trainvali_cams/C02.json', 'r') as h:
		cam = json.load(h)
