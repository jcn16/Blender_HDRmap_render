            ...
            for yaw in range(-32,33,8):
                for scale in [0.8,1,1.1]:
                    for i in range(config.getint('DEFAULT','light_num')):
                        ...
                        light_idx=random.randint(0,len(child_maps))
                        ...
                        rgb_camspc_f = os.path.join(target_path, 'render.png')
                        xm.blender.render.render(rgb_camspc_f)
                        albedo_f = os.path.join(target_path, 'albedo.png')
                        ...
                        AO_f = os.path.join(target_path, 'ambient.png')
