...
def main():
    ...
    # loading obj
    bpy.ops.import_scene.obj(filepath='./126111539896325-h/126111539896325_scaled.obj',
    ...
    xm.blender.light.add_light_env(env='/media/jcn/新加卷/JCN/CLOTHES/Blender_rendering/HDRmaps/9C4A0003-e05009bcad_tone_180.hdr')
